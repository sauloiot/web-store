...
//        MockitoAnnotations.initMocks(this);
    ...
    public void findById() {
        when(produtoRepository.findById(1)).thenReturn(java.util.Optional.of(new Produto(1, "Impressora", 300.00, "Impressora laser", Utils.code5L7N(), 0.00,"imagemURL",  null)));
    ...
    public void findAll()
    {
        ...
        Produto prod1 = new Produto(1, "Impressora", 300.00, "Impressora laser", Utils.code5L7N(), 0.00, "imagemURL", null);
        Produto prod2 = new Produto(2, "Mouse", 100.00, "Mouse sem fio", Utils.code5L7N(), 0.00, "imagemURL", null);
        Produto prod3 = new Produto(3, "Teclado", 200.00, "Teclado sem fio", Utils.code5L7N(), 0.00, "imagemURL", null);
